...
| [<img src="screenshots/dashboard.png" width="120" alt="dashboard template layout">](screenshots/dashboard.png) | Master/stack | [`dashboard`](templates/dashboard.toml) | One wide main window, a single narrow sidebar flanking each side (20%/60%/20%) — dual-sidebars.toml with a wider main window | 3 |
